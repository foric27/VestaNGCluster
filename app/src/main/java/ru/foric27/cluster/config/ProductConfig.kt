...
object ProductConfig {
    ...
    object VisibleArea {
        ...
        /** Нижняя граница `unobscured / visibleArea` в пикселях. Контент заполняет весь дисплей. */
        const val BOTTOM: Int = 640
    ...
    object Video {
        ...
        /** Высота обрезки снизу кадра в пикселях (= Video.HEIGHT - VisibleArea.BOTTOM). 0 = контент на весь дисплей. */
        const val BOTTOM_CROP_PX: Int = 0
    }
